...
enum MagicEffect_t
{
	...
	MAGIC_EFFECT_LAST		= MAGIC_EFFECT_FIREWORK_BLUE,
...
enum ShootEffect_t
{
	...
	SHOOT_EFFECT_LAST		= SHOOT_EFFECT_INFERNALBOLT,
...
enum PlayerCustomFlags
{
	...
	PlayerCustomFlag_IgnoreLoginDelay,			//2^18 = 262144
	PlayerCustomFlag_CanStairhop,				//2^19 = 524288
	PlayerCustomFlag_CanTurnhop,				//2^20 = 1048576
	PlayerCustomFlag_IgnoreHouseRent,				//2^21 = 2097152
	PlayerCustomFlag_CanWearAllAddons,			//2^22 = 4194304
...
#define NETWORK_CRYPTOHEADER_SIZE 4
#define NETWORK_HEADER_SIZE 2

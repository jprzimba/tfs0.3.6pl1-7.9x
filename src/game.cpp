...
bool Game::reloadInfo(ReloadInfo_t reload, uint32_t playerId/* = 0*/)
{
	...
	switch(reload)
	{
		...
		{
			//TODO
			std::clog << "[Notice - Game::reloadInfo] Reload type (ITEMS) does not work." << std::endl;
			done = true;
			break;
		}
		...
		{
			//TODO
			std::clog << "[Notice - Game::reloadInfo] Reload type (OUTFITS) does not work." << std::endl;
			done = true;
			break;
		}
		...
		case RELOAD_VOCATIONS:
		{
			...
			//else
			//	std::clog << "[Notice - Game::reloadInfo] Reload type (VOCATIONS) does not work." << std::endl;
		...
		{
			//TODO
			std::clog << "[Notice - Game::reloadInfo] Reload type (WEAPONS) does not work." << std::endl;
			done = true;
			break;
		}
